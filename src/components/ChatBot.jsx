...
• **Basic Package: US $400 (₡180.000)** — One-time payment or payment plan.  
• **Premium Package: US $700 (₡350.000)** — One-time payment or payment plan.
...
Would you like the demos or full details?`;
    ...
    // SALUDO
    if (t.includes("como estas") || t.includes("how are you") || t.includes("todo bien")|| t.includes("pura vida")|| t.includes("?")) {
      window.location.href = "#home";
      return language === "es"
        ? `Pura Vida! Como Puedo Ayudarte?`
        : `Pura Vida! How can I assist you?`;
    }
    ...
    if (t.includes("nosotros") || t.includes("about") || t.includes("who")) {
      ...
      return language === "es"
        ...
        : `I’m a Costa Rican creator helping businesses grow online. Your website is your modern storefront. Pura vida!`;
    }
    ...
    return language === "es"
      ? `Hola! ¡Pura vida! 😊 Podés preguntarme por Precios, Quienes Somos, Servicios, Nuestros Trabajos o como Contactarnos.`
      : `Hi! Pura vida! 😊 You can ask me about pricing, About Us, Services, Our Work's or contact.`;
  };
  ...
  const sendMessage = () => {
    ...
    const reply = handleSmartResponses(input);
    ...
    <>
      ...
      {!open && (
        <motion.button
          ...
          className={`fixed ${
            isMobile ? "bottom-28 right-4 p-4" : "bottom-58 right-19 p-5"
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className={`
              fixed transform 
              ${isMobile ? "bottom-4 right-4 w-[88%]" : "top-[70%] right-6 w-80 -translate-y-1/2"}
